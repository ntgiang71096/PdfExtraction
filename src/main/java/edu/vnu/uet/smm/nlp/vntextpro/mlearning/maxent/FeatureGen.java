...
public class FeatureGen {
	...
	edu.vnu.uet.smm.nlp.vntextpro.mlearning.maxent.Dictionary dict = null; // dictionary object

	// for scan feature only
	List currentFeatures = null;
	int currentFeatureIdx = 0;

	public FeatureGen(Option option, Data data, edu.vnu.uet.smm.nlp.vntextpro.mlearning.maxent.Dictionary dict) {
		this.option = option;
		this.data = data;
		this.dict = dict;
	}
