...
public class POSSampleExtend extends POSSample {
	...
	public static POSSample parse(String sentenceString, String regex) throws InvalidFormatException {
	...
	public static POSSample parse(String sentenceString, String regex, String character) throws InvalidFormatException {
