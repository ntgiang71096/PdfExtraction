...
public class FeatureGen {
	...
	edu.vnu.uet.smm.nlp.vntextpro.mlearning.flexcrfs.Dictionary dict = null; // dictionary

	public FeatureGen(Maps maps, edu.vnu.uet.smm.nlp.vntextpro.mlearning.flexcrfs.Dictionary dict) {
		this.maps = maps;
		this.dict = dict;
	}
